<?php
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Hanya tambahkan ke peminjamanData jika produk dan qty terisi
    ...
    // Ambil data company identity dari base_entitas berdasarkan entitas_peminjam
    ...
    if ($stmtProducts) {
        mysqli_stmt_bind_param($stmtProducts, "s", $nomor_peminjaman);
    ...
    $tanggalHeader = formatTanggalIndonesia($headerData['tanggal_peminjaman']);
    $bulanHeader = '';
    if (!empty($headerData['tanggal_peminjaman']) && $headerData['tanggal_peminjaman'] !== '0000-00-00') {
        try {
            $date = new DateTime($headerData['tanggal_peminjaman']);
            $bulan = [
                '01' => 'Januari', '02' => 'Februari', '03' => 'Maret', '04' => 'April',
                '05' => 'Mei', '06' => 'Juni', '07' => 'Juli', '08' => 'Agustus',
                '09' => 'September', '10' => 'Oktober', '11' => 'November', '12' => 'Desember'
    ...
    if (!empty($productsByGudang)) {
        ...
        // Jika tidak ada pengelompokan, gunakan totalQty dari $peminjamanData
        $grandTotal = $totalQty;
    }
...
<head>
    <meta charset="utf-8">
    <title>Peminjaman - ' . htmlspecialchars($headerData['nomor_peminjaman']) . '</title>
    <style>
        @page {
            size: A4;
            margin: 8mm;
...
<body>
    <div class="header-right">
        <div class="header-title">Peminjaman</div>
    ...
    if (!empty($allProducts)) {
        ...
        // Fallback: gunakan data dari $peminjamanData jika tidak ada pengelompokan
    ...
    $dompdf->stream('Surat_Jalan_Peminjaman_' . $headerData['nomor_peminjaman'] . '.pdf', [
